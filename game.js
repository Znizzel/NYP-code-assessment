...
playGame.prototype = {
    preload:function(){
        ...
        game.load.image("topping4", "assets/sprites/topping4.png" );
        game.load.image("topping5", "assets/sprites/topping5.png" );
        game.load.image("topping6", "assets/sprites/topping6.png" );
        game.load.image("topping7", "assets/sprites/topping7.png" );
        game.load.image("topping8", "assets/sprites/topping8.png" );
        game.load.image("title", "assets/sprites/title3.png");
  	...
  	create: function(){
        ...
        this.toppingGroup = ["topping1", "topping2", "topping3", "topping4", "topping5", "topping6", "topping7", "topping8"];
    ...
    dropCrate: function(){
        ...
        if(this.canDrop && this.timer <= gameOptions.timeLimit){
            ...
            var fallingCrate = game.add.sprite(this.movingCrate.x, this.movingCrate.y, Phaser.ArrayUtils.getRandomItem(this.toppingGroup));
